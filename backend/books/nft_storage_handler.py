...
class NFTStorageHandler:
    ...
    def store(self, file_path: str):
        self.configuration.__setattr__('access_token', settings.NFT_STORAGE['ACCESS_TOKEN'])
    ...
    def bulk_store(self, dir_path: str) -> str:
        ...
        try:
            ...
            headers = {
                ...
                'authorization': f"Bearer {settings.NFT_STORAGE['ACCESS_TOKEN']}"
            }
    ...
    def get_nft_url(cid: str):
        ...
        :return:
        """
        return f'https://{cid}.{settings.NFT_STORAGE["SUFFIX"]}'

    @classmethod
    def get_file_dir(cls, cid: str, file_name: str):
        """
